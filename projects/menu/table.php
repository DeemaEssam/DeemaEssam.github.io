      ...
      <div class="w3-container w3-padding-64 w3-dark-grey w3-grayscale-min w3-xlarge">
          ...
          <div class="bd-example">
            <table class="table table-striped table-hover justify-content-center" border="4">
              <thead>
                ...
                {
                    $mysqli = new mysqli("localhost", "test", "test", "project");

                    $result2 = $mysqli->query("SELECT userType FROM register WHERE userType=1 AND username='$_SESSION[login_username]'");
              ...
              <tbody>
                ...
                if (isset($_SESSION['login_username']))
                {
                    ...
                    if ($result2->num_rows == 1) 
                      {?>
                        <td class="table-light text-center" scope="col"><a href="/project/delete.php?username=<?php echo $rows['username']; ?>"><button type="submit" class="btn btn-danger" name="delete" id="delete">Delete</button></a></td>
          ...
          if (isset($_SESSION['login_username']))
          {
              ...
              $result3 = $mysqli->query(" SELECT message, username
                                          ...
                                          SELECT username
                                          FROM register
                                          WHERE username = '$_SESSION[login_username]')");
            ...
            <?php } ?>
          <?php }else if (!isset($_SESSION['login_username'])){?>
            <div class="form-inner">
