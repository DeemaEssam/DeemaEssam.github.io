const projects = [
    ...
    
    {
        ...
        shortDescription:
            "مشروع مستقل تم تطويره لصالح مدرس لإنشاء منصة تعليم إلكتروني مخصصة لإدارة الدورات والمحتوى التعليمي والاختبارات، مع نظام صلاحيات متكامل للمستخدمين.",
    
        fullDescription:
            `
            مشروع مستقل (Freelance Project) تم تطويره لصالح مدرس طلب إنشاء منصة تعليم إلكتروني مخصصة لإدارة الدورات والمحتوى التعليمي والاختبارات.
    
            تم تنفيذ المشروع من الصفر بناءً على متطلبات العميل، مع تطوير النظام وربط الواجهة الأمامية بالخادم وقاعدة البيانات لتوفير منصة متكاملة لإدارة وعرض المحتوى التعليمي.
    
            أبرز ما تم تنفيذه:
    
            🌸 تحليل متطلبات العميل وتحويلها إلى نظام ويب متكامل يلبي احتياجاته في إدارة الدورات والمحتوى والاختبارات.
    
            🌸 تطوير تطبيق ويب باستخدام Python وFlask لربط واجهة المستخدم بالخادم وقاعدة البيانات.
    
            🌸 تصميم وإدارة قاعدة بيانات MySQL لتخزين وإدارة بيانات المستخدمين والدورات والأقسام والمحتوى والاختبارات والأسئلة والخيارات.
    
            🌸 تطوير نظام لإدارة الدورات التعليمية يتيح إنشاء الدورات وإضافة الأقسام وتنظيم المحتوى داخل كل دورة.
            ...
            🌸 ربط جميع عمليات إدارة المحتوى مباشرة بقاعدة البيانات لضمان حفظ البيانات وتحديثها بشكل منظم.
            ...
            🌸 اختبار وظائف النظام والتأكد من تكامل الواجهة والخادم وقاعدة البيانات قبل تسليم المشروع للعميل.
    
            تم تسليم المنصة للعميل كنظام متكامل يساعده على إدارة الدورات والمحتوى التعليمي والاختبارات والمستخدمين من خلال منصة واحدة قابلة للتوسع.
            `,
